...
const productDetails = ({data}) => {
  ...
  const {brandName, productName, productDescription, price, _id, imageUrls} = productDetail
  ...
  const desc = productDescription.map((x)=> x.children[0].text)
  ...
  function onAdd(productName, brandName, price, quantity, _id){
    const productAdded = {
      productName,
      price,
      quantity,
        ...
        <div className="bg-white productDetailFonts">
          ...
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-16 justify-center py-16 px-16">
                    ...
                    return (
                      <div className="flex" key={index}>
                        <div className={`sideProductImage ${currentIndex === index ? 'active' : ''}`} onClick={()=> selectImage(index)} key={index}>
                          <Image src={x} alt={productName} className="sideProductImage" width="400" height="200" unoptimized/>
                        </div>
                      </div>
                      )
                    })}          
            ...
            <div className="container text-zinc-700 h-fit mt-4">
              ...
              <h1 className="font-semibold text-xl productName">{productName}</h1>
              ...
              <div className="border-t-2 border-gray-300 w-fit">
                <div className="mt-4">
                  ...
                  <div className="mt-8">
                    <button className="bg-black px-20 py-2 text-sm uppercase text-white" onClick={()=> onAdd(productName, brandName, price, quantity, _id, imageUrls)}>Add to Cart</button>
                  </div>
