...
const Quotes = ({ quote }) => {
  ...
  return (
    <>
      <section className="container mx-auto relative top-28">
        <div className="flex flex-col md:flex-row justify-center bg-gradient-to-r from-green-200 via-green-800 to-gray-800 rounded-lg p-8 space-y-8 md:space-y-0 md:space-x-8 max-w-screen-lg mx-auto">
