...
const Blog = ({blog}) => {
  ...
  return (
    ...
    <div className="container mx-auto text-zinc-100 xl:px-28 md:px-2 my-12">
        ...
        <div className="col-span-3">
          <div className="flex md:flex-row flex-col bg-red-400 p-4 items-start rounded-xl">
            <div className="mx-auto">
              ...
              <Image src={urlFor(blog[0].main_image.asset._ref)} alt="" style={mainImageBlog} width={250} height={250}/>
            </div>
        ...
        {['bg-orange-200', 'bg-green-200', 'bg-pink-200'].map((bgColor, i) => (
          <div key={i} className={`w-full md:w-2/6 ${bgColor} rounded-lg py-4 flex flex-col`}>
            ...
            <div className="flex-grow flex flex-col justify-center items-center">
              <Image src={urlFor(blog[i + 1].main_image.asset._ref)} alt="Blog Image" className="smallImageBlog w-full h-auto md:w-auto" />
